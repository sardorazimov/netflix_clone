...
import {createAccountSchema} from "@/lib/index";
...
import {AccountProps, AccountResponse} from "@/props";
...
const CreateAccount = ({uid, setOpen,setAccounts}:Props) => {
        ...
        try {
         const {data} = await axios.post<AccountResponse>("/api/account", {...values, uid})
          if(data.success) {
            ...
            setAccounts((prevAccounts) => [...prevAccounts, data.data as AccountProps])//+
      // {"conversationId":"29f37126-4d56-4969-bdaf-ea0edca6c00a","source":"instruct"}
            return toast({
