...
import {menuItems} from "@/constants/route";
...
const Navbar = () => {
  ...
  return (
    <div className={"relative "}>
      <header className={cn("header h-[10vh]  hover:bg-white/10 transition-all duration-400 ease-in-out", isScrolled && "backdrop-blur-3xl")}>
        ...
        <div className={"font-light flex items-center justify-end  space-x-4 text-sm"}>
          {showSearchBar ? (
